...
class ProfilePage extends Component {
  ...
  async componentDidMount() {
    ...
    if (res !== undefined && res.status == 200) {
      ...
      this.setState({
        showToast: true,
        toastMessage: "Ocorreu um erro ao carregar o perfil",
        toastType: "danger",
      });
    }
  }
      ...
      await fetch(
        ...
        .then((response) => {
          if (response !== undefined && response.status === 200) {
            this.setState({
              showToast: true,
              toastMessage: "Perfil alterado com sucesso",
              toastType: "success",
            });
          } else {
            this.setState({
              showToast: true,
              toastMessage: "Ocorreu um erro ao alterar o perfil",
              toastType: "danger",
            });
          }
          response.json();
    ...
    return (
      <>
        <div
          ...
          style={{ gridColumn: "1", gridRow: "1", marginTop: "10%" }}
        >
          <h1>Perfil</h1>
          <br />
          <img
        ...
        >
          ...
          <div>
            <Button
              variant="secondary"
              style={{ float: "left", marginLeft: "13%" }}
